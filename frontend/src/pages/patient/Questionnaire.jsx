...
const TREE = {
  ...
  options: [
    ...
    {
      label: 'Stomach Pain / पेट दर्द', emoji: '🤢',
      next: {
    ...
    {
      label: 'Chest Pain / सीने में दर्द', emoji: '💓',
      next: { result: 'chest_emergency' }
    },
    {
      label: 'Wound / Cut / घाव', emoji: '🩹',
      next: {
